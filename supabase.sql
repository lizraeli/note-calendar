...
--
-- Name: notes Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: notes Users can access their own notes; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can access their own notes" ON public.notes FOR SELECT USING ((( SELECT auth.uid() AS uid) = user_id));


--
-- Name: notes Users can update their own notes; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can update their own notes" ON public.notes FOR UPDATE USING ((( SELECT auth.uid() AS uid) = user_id));
